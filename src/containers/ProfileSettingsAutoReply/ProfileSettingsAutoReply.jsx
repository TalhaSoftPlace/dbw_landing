...
export const ProfileSettingsAutoReply = React.memo(() => {
  ...
  let validationSchema = yup.object({
    autoReplyText: yup
      .string('Enter auto reply Text')
      .trim()
      .required('Auto reply Text is required.'),
  });
  ...
  return (
    <>
      ...
      >
        {(props) => {
          return <ProfileautoReplyForm {...props} />;
        }}
      </Formik>
    </>
  );
