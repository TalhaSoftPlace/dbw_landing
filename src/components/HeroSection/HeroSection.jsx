...
import { Button, InvitationDialog } from '../../components';
      ...
      <Container maxWidth="lg">
        <Grid container spacing={2}>
          <Grid item md={5} lg={5} sm={12} xs={12} mt={6}>
            <Wrapper>
              <Typography variant="h2">{t.heroHeading1} <br /> {t.heroHeading2} </Typography>
              <Typography mt={4} variant="h2">
                {t.heroSubheading}
              </Typography>
              <Typography variant="h4" sx={{ color: '#9a9ea5 !important' }} >{t.heroTagLine}</Typography>
              <Box sx={{ display: 'flex', gap: 4 }}>
                <Grid className="login-signup-grid" container>
                  ...
                  <Grid item md={7} lg={7} sm={6} xs={6}>
                    <Button className="signin-btn" variant="outlined" onClick={handleLogin}>
                      {t.signin}
                    </Button>
                  </Grid>
                </Grid>
          ...
          <Grid sx={{ margin: 'auto', display: 'flex', justifyContent: 'center' }} item lg={7} md={7} sm={12}>
            {/* <WithBGIcons size={20}>
            </WithBGIcons> */}
            <EmailBox>
